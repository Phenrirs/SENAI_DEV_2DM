...
INSERT INTO Empresa(nomeEmpresa,Edereço)
VALUES('UNIDAS','Rua. 123Abd')

INSERT INTO Clientes(nomeClientes)
VALUES('João'),('Carlos'),('Lucas'),('Saulo')
...
INSERT INTO Aluguel(idVeiculo,idClientes,Preço,Inicio,Fim)
